              ...
              $.each(data, function(i,item) {
                ...
                if (count <= '.$count.') {
                    ...
                    if (show_intents) {
                      ...
                      intents = intents + \'<li><a href="https://twitter.com/intent/tweet?in_reply_to=##ID##" class="reply ss-icon ss-standard">Reply</a></li>\';
                      intents = intents + \'<li><a href="https://twitter.com/intent/retweet?tweet_id=##ID##" class="retweet ss-icon ss-standard">Retweet</a></li>\';
                      intents = intents + \'<li><a href="https://twitter.com/intent/favorite?tweet_id=##ID##" class="favorite ss-icon ss-standard">Favorite</a></li>\';
                      intents = intents + \'</ul>\';
